...
<html lang="en" data-textdirection="ltr" class="loading">
  ...
  <body data-open="click" data-menu="vertical-menu" data-col="2-columns" class="vertical-layout vertical-menu 2-columns  fixed-navbar">
    ...
    <!-- navbar-fixed-top-->
    <nav class="header-navbar navbar navbar-with-menu fixed-top navbar-dark navbar-shadow">
      <div class="navbar-wrapper">

          <ul class="nav navbar-nav">
            <li class="nav-item mobile-menu d-md-none float-xs-left"><a class="nav-link nav-menu-main menu-toggle d-none d-sm-block"><i class="icon-menu5 font-large-1"></i></a></li>
            ...
            <li class="nav-item d-md-none float-xs-right"><a data-toggle="collapse" data-target="#navbar-mobile" class="nav-link open-navbar-container"><i class="icon-ellipsis pe-2x icon-icon-rotate-right-right"></i></a></li>
          </ul>

        <div class="navbar-container content container-fluid">
          <div id="navbar-mobile" class="collapse navbar-toggleable-sm">
            <ul class="nav navbar-nav">
              <li class="nav-item d-none d-md-block"><a class="nav-link nav-menu-main menu-toggle d-none d-sm-block"><i class="icon-menu5">         </i></a></li>
              <li class="nav-item d-none d-md-block"><a href="#" class="nav-link nav-link-expand"><i class="ficon icon-expand2"></i></a></li>
