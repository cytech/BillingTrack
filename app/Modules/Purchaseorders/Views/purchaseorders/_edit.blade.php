    ...
    <div class="float-right">
        ...
        @if (config('bt.mailConfigured'))
            <a href="javascript:void(0)" id="btn-email-purchaseorder" class="btn btn-secondary email-purchaseorder"
               data-purchaseorder-id="{{ $purchaseorder->id }}" data-redirect-to="{{ route('purchaseorders.edit', [$purchaseorder->id]) }}"><i
                            ...
                            <table id="item-table" class="table table-hover">
                                ...
                                <tr id="new-item" style="display: none;">
                                    <td>
                                        ...
                                        <label><input type="checkbox" name="save_item_as_product" tabindex="999"> @lang('bt.save_item_as_product')</label>
                                    </td>
                                ...
                                @foreach ($purchaseorder->items as $item)
                                    <tr class="item" id="tr-item-{{ $item->id }}">
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-secondary btn-delete-purchaseorder-item" href="javascript:void(0);"
