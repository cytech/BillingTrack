    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form>
                    ...
                    @if ($invoices)
                        ...
                        <div class="form-group">
                            <label class="col-form-label">{!! Form::radio('add_line_item', 1, true, ['class' => 'add-line-item']) !!} @lang('bt.add_line_item_to_invoice')</label><br>
                            <label class="col-form-label">{!! Form::radio('add_line_item', 0, false, ['class' => 'add-line-item']) !!} @lang('bt.do_not_add_line_item_to_invoice')</label>
                        </div>
            ...
            <div class="modal-footer">
                ...
                @if ($invoices)
                    <button type="button" id="btn-create-expense-bill-confirm" class="btn btn-primary">@lang('bt.submit')</button>
                @endif
            </div>
        </div>
    </div>
