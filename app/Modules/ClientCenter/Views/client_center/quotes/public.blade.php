            ...
            <div style="margin-bottom: 15px;">
                ...
                @if (in_array($quote->status_text, ['draft', 'sent']))
                    <a href="#" class="btn btn-primary"
                       onclick="swalConfirm('@lang('bt.confirm_approve_quote')', '{{ route('clientCenter.public.quote.approve', [$quote->url_key]) }}');">
                        <i class="fa fa-thumbs-up"></i> @lang('bt.approve')
                    </a>
                    <a href="#" class="btn btn-primary"
                       onclick="swalConfirm('@lang('bt.confirm_reject_quote')', '{{ route('clientCenter.public.quote.reject', [$quote->url_key]) }}');">
