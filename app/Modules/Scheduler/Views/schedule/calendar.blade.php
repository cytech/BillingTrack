    ...
    <div class="container col-lg-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="fa fa-fw fa-th fa-fw"></i><a
                                    href="{{ route('scheduler.index') }}">{{ trans('fi.schedule') }}</a> /{{ trans('fi.calendar') }}</h3>
                    </div>
        ...
        <div id="calEventDialog" title="{{ trans('fi.create_event_calendar') }}" style="display: none">
            <form class="form-horizontal" id="saveCalendarEvent">
                ...
                <div class="form-group">
                    <label for="title" class="col-sm-4 control-label">{{ trans('fi.title') }}</label>
                    <div class="col-sm-8">
                ...
                <div class="form-group">
                    <label for="description"
                           class="col-sm-4 control-label">{{ trans('fi.description') }}</label>
                    <div class="col-sm-8">
                ...
                <div class="form-group">
                    <label for="to"
                           class="col-sm-4 control-label">{{ trans('fi.end_datetime') }}</label>
                    <div class="col-sm-8">
                ...
                <div class="form-group">
                    <label for="category"
                           class="col-sm-4 control-label">{{ trans('fi.category') }}</label>
                    <div class="col-sm-8">
        ...
        <div id="editEvent" title="{{ trans('fi.update_event_calendar') }}" style="display: none">
            <form class="form-horizontal" id="updateCalendarEvent">
                ...
                <div class="form-group">
                    <label for="editTitle"
                           class="col-sm-4 control-label">{{ trans('fi.title') }}</label>
                    <div class="col-sm-8">
                ...
                <div class="form-group">
                    <label for="editStart"
                           class="col-sm-4 control-label">{{ trans('fi.start_date') }}</label>
                    <div class="col-sm-8">
                ...
                <div class="form-group">
                    <label for="editEnd"
                           class="col-sm-4 control-label">{{ trans('fi.end_date') }}</label>
                    <div class="col-sm-8">
        ...
        <div class="addReminderView" style="display: none">
            <div class="reminder_delete_div">
                ...
                <div class="form-group">
                    <label for="reminder_date" class="col-sm-4 control-label">{{ trans('fi.reminder_date') }}</label>
                    <div class="col-sm-8">
                ...
                <div class="form-group">
                    <label for="reminder_location" class="col-sm-4 control-label">{{ trans('fi.reminder_location') }}</label>
                    <div class="col-sm-8">
                        <input type="text" name="reminder_location[]" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                    <label for="reminder_text" class="col-sm-4 control-label">{{ trans('fi.reminder_text') }}</label>
                    <div class="col-sm-8">
