...
@section('content')
    ...
    <div class="col-lg-9 documentation">
        ...
        <p><a href="#how-to-translate">How do I translate BillingTrack into my own language?</a></p>
        <p><a href="#can-i-share">Can I share my translation for others to use?</a></p>

        <hr>

        <span class="anchor" id="how-to-translate"></span>
        <h3>How do I translate BillingTrack into my own language?</h3>

        <p>
            The translation files for BillingTrack live in the resources/lang folder. To translate BillingTrack into
            your
