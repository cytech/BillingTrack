...
@section('content')
    ...
    <div class="col-lg-9 documentation">
        ...
        <p>To configure BillingTrack for online payments, click the System icon and select System Settings.</p>
        ...
        <p>Each of the different payment gateways that are compatible with BillingTrack are listed on the
        ...
        <p>Prior to version 2018-7, BillingTrack used PayPal's classic NVP/SOAP api. Version 2018-7 and later use
            PayPal's REST api.</p>
        ...
        <p>Give the app a name, such as BillingTrack (or whatever you'd like) and click the Create App button.</p>
        ...
        <p>Once the app is created, the Client ID and Secret ID can be obtained. Note there is an option to switch
            ...
            note the
            Secret ID spans two lines, so be sure the entire key gets copied. Configure the keys in BillingTrack on the
            Online Payments
        ...
        <p>Once you have BillingTrack configured to accept online payments, clients may pay their invoices using the
