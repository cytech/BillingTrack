...
@section('content')
    ...
    <div class="col-lg-9 documentation">
        ...
        <a href="../../../assets/img/docs/2018/time_tracking1.png" target="_blank">
            <img src="../../../assets/img/docs/2018/time_tracking1_small.png" class="img-responsive">
        </a>

        <p>Press the Create Project button.</p>
        <a href="../../../assets/img/docs/2018/time_tracking_create_project1.png" target="_blank">
            <img src="../../../assets/img/docs/2018/time_tracking_create_project1_small.png" class="img-responsive">
        </a>
        ...
        <a href="../../../assets/img/docs/2018/time_tracking_create_project2.png" target="_blank">
            <img src="../../../assets/img/docs/2018/time_tracking_create_project2_small.png" class="img-responsive">
        </a>
        ...
        <a href="../../../assets/img/docs/2018/time_tracking_add_task1.png" target="_blank">
            <img src="../../../assets/img/docs/2018/time_tracking_add_task1_small.png" class="img-responsive">
        </a>
        ...
        <a href="../../../assets/img/docs/2018/time_tracking_add_task2.png" target="_blank">
            <img src="../../../assets/img/docs/2018/time_tracking_add_task2_small.png" class="img-responsive">
        </a>
        ...
        <a href="../../../assets/img/docs/2018/time_tracking_add_task3.png" target="_blank">
            <img src="../../../assets/img/docs/2018/time_tracking_add_task3_small.png" class="img-responsive">
        </a>

        <p>Timers can be manually added or deleted to a task by clicking the Show Timers icon.</p>
        <a href="../../../assets/img/docs/2018/time_tracking_task_timers1.png" target="_blank">
            <img src="../../../assets/img/docs/2018/time_tracking_task_timers1_small.png" class="img-responsive">
        </a>

        <p>Any timers currently associated with the task will be listed here.</p>
        <a href="../../../assets/img/docs/2018/time_tracking_task_timers2.png" target="_blank">
            <img src="../../../assets/img/docs/2018/time_tracking_task_timers2_small.png" class="img-responsive">
        </a>
        ...
        <a href="../../../assets/img/docs/2018/time_tracking_task_timers3.png" target="_blank">
            <img src="../../../assets/img/docs/2018/time_tracking_task_timers3_small.png" class="img-responsive">
        </a>
        ...
        <a href="../../../assets/img/docs/2018/time_tracking_bill_task1.png" target="_blank">
            <img src="../../../assets/img/docs/2018/time_tracking_bill_task1_small.png" class="img-responsive">
        </a>
        ...
        <a href="../../../assets/img/docs/2018/time_tracking_bill_task2.png" target="_blank">
            <img src="../../../assets/img/docs/2018/time_tracking_bill_task2_small.png" class="img-responsive">
        </a>

        <p>Once tasks have been billed, they will appear under the Billed Tasks area.</p>
        <a href="../../../assets/img/docs/2018/time_tracking_bill_task3.png" target="_blank">
            <img src="../../../assets/img/docs/2018/time_tracking_bill_task3_small.png" class="img-responsive">
        </a>
