    ...
    <script type="text/javascript">
        $(function () {
            $('#btn-run-report').click(function () {
                ...
                $.post("{{ route('clientStatement.validate') }}", {
                    from_date: from_date,
                    to_date: to_date,
                    ...
                    if (output_type == 'preview') {
                        $('#preview').show();
                        $('#preview-results').attr('src', "{{ route('clientStatement.html') }}" + query_string);
                    }
                    else if (output_type == 'pdf') {
                        window.location.href = "{{ route('clientStatement.pdf') }}" + query_string;
                    }
