...
@foreach ($customFields as $customField)
        ...
        @else
            {!! call_user_func_array('Form::' . $customField->field_type, ['custom[' . $customField->column_name . ']',
                (isset($object->custom->{$customField->column_name}) ? ($customField->column_name == 'job_date')? Addons\Workorders\Support\DateFormatter::format($object->custom->{$customField->column_name}):$object->custom->{$customField->column_name} : null),
