...
<section class="content-header">
    <h3 class="float-left">@lang('fi.recurring_invoice') #{{ $recurringInvoice->id }}</h3>
        ...
        <div class="btn-group">
            ...
            <div class="dropdown-menu dropdown-menu-right" role="menu">
                ...
                <a class="dropdown-item" href="#"
                       onclick="swalConfirm('@lang('fi.trash_record_warning')', '{{ route('recurringInvoices.delete', [$recurringInvoice->id]) }}');"><i
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-append">
                                <button class="btn btn-sm" id="btn-update-exchange-rate" type="button"
                                        data-toggle="tooltip" data-placement="left" title="@lang('fi.update_exchange_rate')">
