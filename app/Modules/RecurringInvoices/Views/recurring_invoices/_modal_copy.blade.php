        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form>
                    ...
                    <div class="form-group d-flex align-items-center">
                        <label class="col-sm-4 text-right text">{{ trans('fi.start_date') }}</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group d-flex align-items-center">
                        <label class="col-sm-4 text-right text">{{ trans('fi.every') }}</label>
                        <div class="col-sm-8">
                            <div class="row">
                                <div class="col-sm-3">
                    ...
                    <div class="form-group d-flex align-items-center">
                        <label class="col-sm-4 text-right text">{{ trans('fi.stop_date') }}</label>
                        <div class="col-sm-8">
