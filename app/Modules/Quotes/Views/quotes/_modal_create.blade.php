    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">@lang('bt.create_quote')</h4>
            ...
            <div class="modal-body">
                ...
                <form>
                    ...
                    <div class="form-group d-flex align-items-center">
                        ...
                        <div class="col-sm-8">
                            {!! Form::text('quote_date', date(config('bt.dateFormat')), ['id' => 'create_quote_date', 'class' => 'form-control']) !!}
                        </div>
                    </div>
                    <div class="form-group d-flex align-items-center">
                    ...
                    <div class="form-group d-flex align-items-center">
                        ...
                        <div class="col-sm-8">
                            {!! Form::select('group_id', $groups, config('bt.quoteGroup'), ['id' => 'create_group_id', 'class' => 'form-control']) !!}
                        </div>
                    </div>
                </form>
            </div>
