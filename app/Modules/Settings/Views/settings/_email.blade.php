...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <span class="help-block"><a href="/documentation/fusioninvoicefoss/docs/2018/Customization/Email-Templates.html#quote-email-template" target="_blank">{{ trans('fi.available_fields') }}</a></span>
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            ...
            <span class="help-block"><a href="/documentation/fusioninvoicefoss/docs/2018/Customization/Email-Templates.html#invoice-email-template" target="_blank">{{ trans('fi.available_fields') }}</a></span>
        </div>
    </div>
</div>
...
<div class="form-group">
    ...
    <span class="help-block"><a href="/documentation/fusioninvoicefoss/docs/2018/Customization/Email-Templates.html#payment-receipt-email-template" target="_blank">{{ trans('fi.available_fields') }}</a></span>
</div>
