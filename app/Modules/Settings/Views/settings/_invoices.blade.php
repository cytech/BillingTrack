<div class="row">
    ...
    <div class="col-md-3">
        <div class="form-group">
            <label>@lang('fi.invoices_due_after'): </label>
...
<div class="form-group">
    ...
    {!! Form::textarea('setting[invoiceTerms]', config('fi.invoiceTerms'), ['class' => 'form-control', 'rows' => 2]) !!}
</div>

<div class="form-group">
    <label>@lang('fi.default_footer'): </label>
    {!! Form::textarea('setting[invoiceFooter]', config('fi.invoiceFooter'), ['class' => 'form-control', 'rows' => 2]) !!}
</div>

<div class="row">
    <div class="col-md-3">
        <div class="form-group">
            <label>@lang('fi.automatic_email_on_recur'): </label>
    ...
    <div class="col-md-3">
        <div class="form-group">
            <label>@lang('fi.automatic_email_payment_receipts'): </label>
...
<div class="row">
    <div class="col-md-3">
        <div class="form-group">
            <label>@lang('fi.if_invoice_is_emailed_while_draft'): </label>
    ...
    <div class="col-md-3">
        <div class="form-group">
            <label>@lang('fi.recalculate_invoices'): </label><br>
            @if (!config('app.demo'))
