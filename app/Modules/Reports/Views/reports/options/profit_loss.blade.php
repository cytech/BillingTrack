...
@section('content')
    ...
    <section class="content-header">
        <h1 class="float-left">@lang('bt.profit_and_loss')</h1>
        ...
        <div class="card card-light">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>@lang('bt.include_profit_based_on'):</label>
                            {!! Form::select('include_profit_based_on', ['invoice_date' => trans('bt.invoice_date'), 'payment_date' => trans('bt.payment_date')], null, ['id' => 'include_profit_based_on', 'class' => 'form-control'])  !!}
                        </div>
                    </div>
                </div>
