...
@section('content')
    ...
    <section class="content-header">
        <h1 class="float-left">@lang('bt.tax_summary')</h1>
        ...
        <div class="card card-light">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>@lang('bt.exclude_unpaid_invoices'):</label>
                            {!! Form::select('exclude_unpaid_invoices', ['0' => trans('bt.no'), '1' => trans('bt.yes')], null, ['id' => 'exclude_unpaid_invoices', 'class' => 'form-control'])  !!}
                        </div>
                    </div>
                </div>
