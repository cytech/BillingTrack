...
SET @newschema = FusionInvoiceFOSS-dev;
SET @oldschema = FusionInvoice-dev;
#template
...
#activities
insert into `@newschema`.activities (id, audit_type, activity, audit_id, info, created_at, updated_at)
SELECT id, audit_type, activity, audit_id, info, created_at, updated_at FROM `@oldschema`.activities;
#addons
insert into `@newschema`.addons (id, created_at, updated_at, name, author_name, author_url, navigation_menu, system_menu, path, enabled, navigation_reports)
...
#attachments
insert into `@newschema`.attachments (id, created_at, updated_at, user_id, attachable_id, attachable_type, filename, mimetype, size, url_key, client_visibility)
...
#clients
insert into `@newschema`.clients (id, created_at,updated_at,name,address,city,state,zip,country,phone,fax,mobile,email,web,url_key,active,currency_code,unique_name,language)
...
#clients_custom
insert into `@newschema`.clients_custom (client_id, created_at, updated_at)
SELECT client_id, created_at, updated_at FROM `@oldschema`.clients_custom;
#company_profiles
insert into `@newschema`.company_profiles (id, created_at, updated_at, company, address, city, state, zip, country, phone, fax, mobile, web, logo, quote_template, invoice_template)
...
insert into `@newschema`.company_profiles_custom (company_profile_id, created_at, updated_at)
SELECT company_profile_id, created_at, updated_at FROM `@oldschema`.company_profiles_custom;
#contacts
insert into `@newschema`.contacts (id, created_at, updated_at, client_id, name, email, default_to, default_cc, default_bcc)
SELECT id, created_at, updated_at, client_id, name, email, default_to, default_cc, default_bcc FROM `@oldschema`.contacts;
#currencies
insert into `@newschema`.currencies (id, created_at, updated_at, code, name, symbol, placement, `decimal`, thousands)
SELECT id, created_at, updated_at, code, name, symbol, placement, `decimal`, thousands FROM `@oldschema`.currencies;
#custom_fields
insert into `@newschema`.custom_fields (id, created_at, updated_at, tbl_name, column_name, field_label, field_type, field_meta)
SELECT id, created_at, updated_at, tbl_name, column_name, field_label, field_type, field_meta FROM `@oldschema`.custom_fields;
#expense_categories
insert into `@newschema`.expense_categories (id, created_at, updated_at, name)
SELECT id, created_at, updated_at, name FROM `@oldschema`.expense_categories;
#expense_vendors
insert into `@newschema`.expense_vendors (id, created_at, updated_at, name)
SELECT id, created_at, updated_at, name FROM `@oldschema`.expense_vendors;
#expenses
insert into `@newschema`.expenses (id, created_at, updated_at, expense_date, user_id, category_id, client_id, vendor_id, invoice_id, description, amount, tax, company_profile_id)
...
#expenses_custom
insert into `@newschema`.expenses_custom (expense_id, created_at, updated_at)
SELECT expense_id, created_at, updated_at FROM `@oldschema`.expenses_custom;
#groups
insert into `@newschema`.groups (id, created_at, updated_at, name, next_id, left_pad, format, reset_number, last_id, last_year, last_month, last_week, last_number)
...
#invoice_amounts
insert into `@newschema`.invoice_amounts (id, created_at, updated_at, invoice_id, subtotal, discount, tax, total, paid, balance)
...
insert into `@newschema`.invoice_item_amounts (id, created_at, updated_at, item_id, subtotal, tax_1, tax_2, tax, total)
...
insert into `@newschema`.invoice_items (id, created_at, updated_at, invoice_id, tax_rate_id, tax_rate_2_id,  name, description, quantity, display_order, price)
...
#invoice_tax_rates
#insert into `@newschema`.invoice_tax_rates (id, created_at, updated_at, invoice_id, tax_rate_id, include_item_tax, tax_total)
#SELECT id, created_at, updated_at, invoice_id, tax_rate_id, include_item_tax, tax_total FROM `@oldschema`.invoice_tax_rates;
#invoice_transactions
insert into `@newschema`.invoice_transactions (id, created_at, updated_at, invoice_id, is_successful, transaction_reference)
SELECT id, created_at, updated_at, invoice_id, is_successful, transaction_reference FROM `@oldschema`.invoice_transactions;
#invoices
insert into `@newschema`.invoices (id, created_at, updated_at, invoice_date, user_id, client_id, group_id, invoice_status_id, due_at, number, terms, footer, url_key, currency_code, exchange_rate, template, summary, viewed, discount, company_profile_id)
...
#invoices_custom
insert into `@newschema`.invoices_custom (invoice_id, created_at, updated_at)
SELECT invoice_id, created_at, updated_at FROM `@oldschema`.invoices_custom;
#item_lookups  - category, resource_table, resource_id,
insert into `@newschema`.item_lookups (id, created_at, updated_at, name, description, price,  tax_rate_id, tax_rate_2_id)
SELECT id, created_at, updated_at, name, description, price, tax_rate_id, tax_rate_2_id FROM `@oldschema`.item_lookups;
#mail_queue
insert into `@newschema`.mail_queue (id, created_at, updated_at, mailable_id, mailable_type, `from`, `to`, cc, bcc, subject, body, attach_pdf, sent, error)
...
#merchant_clients
insert into `@newschema`.merchant_clients (id, created_at, updated_at, driver, client_id, merchant_key, merchant_value)
SELECT id, created_at, updated_at, driver, client_id, merchant_key, merchant_value FROM `@oldschema`.merchant_clients;
#merchant_payments
insert into `@newschema`.merchant_payments (id, created_at, updated_at, driver, payment_id, merchant_key, merchant_value)
SELECT id, created_at, updated_at, driver, payment_id, merchant_key, merchant_value FROM `@oldschema`.merchant_payments;
#migrations
#notes
insert into `@newschema`.notes (id, created_at, updated_at, user_id, notable_id, notable_type, note, private)
SELECT id, created_at, updated_at, user_id, notable_id, notable_type, note, private FROM `@oldschema`.notes;
#payment_methods
insert into `@newschema`.payment_methods (id, created_at, updated_at, name)
SELECT id, created_at, updated_at, name FROM `@oldschema`.payment_methods;
#payments
insert into `@newschema`.payments (id, created_at, updated_at, invoice_id, payment_method_id, paid_at, note, amount)
SELECT id, created_at, updated_at, invoice_id, payment_method_id, paid_at, note, amount FROM `@oldschema`.payments;
#payments_custom
insert into `@newschema`.payments_custom (payment_id, created_at, updated_at)
SELECT payment_id, created_at, updated_at FROM `@oldschema`.payments_custom;
#quote_amounts
insert into `@newschema`.quote_amounts (id, created_at, updated_at, quote_id, subtotal, discount, tax, total)
SELECT id, created_at, updated_at, quote_id, subtotal, discount, tax, total FROM `@oldschema`.quote_amounts;
#quote_item_amounts
insert into `@newschema`.quote_item_amounts (id, created_at, updated_at, item_id, subtotal, tax_1, tax_2, tax, total)
SELECT id, created_at, updated_at, item_id, subtotal, tax_1, tax_2, tax, total FROM `@oldschema`.quote_item_amounts;
#quote_items
insert into `@newschema`.quote_items (id, created_at, updated_at, quote_id, tax_rate_id, tax_rate_2_id, name, description, quantity, display_order, price)
...
#quote_tax_rates
#insert into `@newschema`.quote_tax_rates (id, created_at, updated_at, quote_id, tax_rate_id, include_item_tax, tax_total)
#SELECT id, created_at, updated_at, quote_id, tax_rate_id, include_item_tax, tax_total FROM `@oldschema`.quote_tax_rates;
#quotes
insert into `@newschema`.quotes (id, created_at, updated_at, quote_date, invoice_id, user_id, client_id, group_id, quote_status_id, expires_at, number, footer, url_key, currency_code, exchange_rate, terms, template, summary, viewed, discount, company_profile_id)
...
#quotes_custom
insert into `@newschema`.quotes_custom (quote_id, created_at, updated_at)
SELECT quote_id, created_at, updated_at FROM `@oldschema`.quotes_custom;
#recurring_invoice_amounts
insert into `@newschema`.recurring_invoice_amounts (id, created_at, updated_at, recurring_invoice_id, subtotal, discount, tax, total)
...
insert into `@newschema`.recurring_invoice_item_amounts (id, created_at, updated_at, item_id, subtotal, tax_1, tax_2, tax, total)
SELECT id, created_at, updated_at, item_id, subtotal, tax_1, tax_2, tax, total FROM `@oldschema`.recurring_invoice_item_amounts;
#recurring_invoice_items
insert into `@newschema`.recurring_invoice_items (id, created_at, updated_at, recurring_invoice_id, tax_rate_id, tax_rate_2_id, name, description, quantity, display_order, price)
...
#recurring_invoices
insert into `@newschema`.recurring_invoices (id, created_at, updated_at, user_id, client_id, group_id, company_profile_id, terms, footer, currency_code, exchange_rate, template, summary, discount, recurring_frequency, recurring_period, next_date, stop_date)
...
insert into `@newschema`.recurring_invoices_custom (recurring_invoice_id, created_at, updated_at)
...
#schedule_settings
#settings
insert into `@newschema`.settings (id, created_at, updated_at, setting_key, setting_value)
SELECT id, created_at, updated_at, setting_key, setting_value FROM `@oldschema`.settings;
#tax_rates
insert into `@newschema`.tax_rates (id, created_at, updated_at, name, percent, is_compound, calculate_vat)
...
#users
insert into `@newschema`.users (id, created_at, updated_at, email, password, name, remember_token, api_public_key, api_secret_key, client_id)
...
#users_custom
insert into `@newschema`.users_custom (user_id, created_at, updated_at)
